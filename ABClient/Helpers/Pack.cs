namespace ABClient.Helpers
{
    ...
    {
        internal static byte[] PackArray(byte[] writeData)
        {
        ...
        internal static byte[] UnpackArray(byte[] compressedData)
        {
        ...
        internal static string PackString(string data)
        {
        ...
        internal static string UnpackString(string data)
        {
