...
{
    view_build_top();
    d.write('<table cellpadding=0 cellspacing=0 border=0 width=100%><tr><td bgcolor=#FFFFFF align=center><div style="position: absolute; border: 1px solid black; overflow: hidden; width: 700px; height: 300px; left: 50%; margin-left: -350px;" id="world_cont"></div><div style="width: 700px; height: 300px; text-align: left;" id="world_cont2"></div></td></tr></table>');
