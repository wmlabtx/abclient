...
function showMap(x, y) {
    ...
    framelabel = window.external.GetCellLabel(x, y);
    ...
    for (i = -height; i <= height; i++) {
        ...
        for (j = -width; j <= width; j++) {
            ...
            var frameborders = window.external.GetRegionBorders(framelabel, dx, dy);
            ...
            if (isCellExists) {
                ...
                if (frameborders.charAt(0) == '1') {
                    td.style.borderTopColor = '#FFFFFF';
                }

                if (frameborders.charAt(1) == '1') {
                    td.style.borderLeftColor = '#FFFFFF';
                }

                if (frameborders.charAt(2) == '1') {
                    td.style.borderRightColor = '#FFFFFF';
                }

                if (frameborders.charAt(3) == '1') {
                    td.style.borderBottomColor = '#FFFFFF';
                }                   

                if (frameborders.charAt(4) == '1') {
                    img.style.filter = "alpha(opacity=100)";
                }                   
                else {
                    img.style.filter = "alpha(opacity=55)";
                }
                ...
                img.id = 'img_' + dx + '_' + dy;
                img.alt = 'Недоступно';
                img.style.filter = "alpha(opacity=33)";
    ...
    switch (dir) {
        case 'bottom':
            ...
            for (i = loaded_left; i <= loaded_right; i++) {
                ...
                var frameborders = window.external.GetRegionBorders(framelabel, i, loaded_bottom);
                if (isCellExists) {
                    td = d.createElement('TD');
                    td.style.borderColor = '#000000';
                    td.style.borderWidth = '1px';
        ...
        case 'top':
            ...
            for (i = loaded_left; i <= loaded_right; i++) {
                ...
                var frameborders = window.external.GetRegionBorders(framelabel, i, loaded_top);
                if (isCellExists) {
                    td = d.createElement('TD');
                    td.style.borderColor = '#000000';
                    td.style.borderWidth = '1px';
        ...
        case 'right':
            ...
            for (i = loaded_top; i <= loaded_bottom; i++) {
                ...
                var frameborders = window.external.GetRegionBorders(framelabel, loaded_right, i);
                if (isCellExists) {
                    td = d.createElement('TD');
                    td.style.borderColor = '#000000';
                    td.style.borderWidth = '1px';
        ...
        case 'left':
            ...
            for (i = loaded_top; i <= loaded_bottom; i++) {
                ...
                var frameborders = window.external.GetRegionBorders(framelabel, loaded_left, i);
                if (isCellExists) {
                    td = d.createElement('TD');
                    td.style.borderColor = '#000000';
                    td.style.borderWidth = '1px';
