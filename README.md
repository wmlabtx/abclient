Исходные тексты клиента даны только для ознакомления. Это не исходники последней версия клиента! Не пытайтесь компилировать и играть, после последних изменений на сервере вы рискуете получить бан.
